...
public final class _DQSPServerDelM extends Ice._ObjectDelM implements _DQSPServerDel
{
    public void
    ...
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("addPassager", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
    ...
    addReclamation(int idPassager, String nomAeroport, String terminale, String nomService, String remarque, String descriptif, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("addReclamation", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
    ...
    getAllAnalysisTable(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getAllAnalysisTable", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
            {
                ...
                java.util.List<AnalyseTable> __ret;
                __ret = aTableHelper.read(__is);
    ...
    getAllReclamations(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getAllReclamations", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
            {
                ...
                IceInternal.BasicStream __is = __og.is();
                __is.startReadEncaps();
                java.util.List<Reclamation> __ret;
                __ret = reclamationsListHelper.read(__is);
                __is.readPendingObjects();
                __is.endReadEncaps();
                return __ret;
            }
    ...
    getAllServices(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getAllServices", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
            {
                ...
                IceInternal.BasicStream __is = __og.is();
                __is.startReadEncaps();
                java.util.List<VService> __ret;
                __ret = serviceListHelper.read(__is);
                __is.readPendingObjects();
                __is.endReadEncaps();
                return __ret;
            }
    ...
    getMailingList(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getMailingList", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
            {
                ...
                IceInternal.BasicStream __is = __og.is();
                __is.startReadEncaps();
                java.util.List<VPassager> __ret;
                __ret = mailListHelper.read(__is);
                __is.readPendingObjects();
                __is.endReadEncaps();
                return __ret;
            }
    ...
    getReclamationsSortedList(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getReclamationsSortedList", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
            {
                ...
                __is.startReadEncaps();
                java.util.List<AnalyseTable> __ret;
                __ret = reclamationsSortedListHelper.read(__is);
                __is.readPendingObjects();
                __is.endReadEncaps();
                return __ret;
            }
    ...
    updateActionsEntreprises(String theme, boolean validation, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("updateActionsEntreprises", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
    ...
    updateAnalyseTable(String theme, String action, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("updateAnalyseTable", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
