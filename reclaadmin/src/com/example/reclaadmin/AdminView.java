...
public class AdminView extends VerticalLayout {
	...
	public AdminView(ReclaadminApplication application)
	{
		...
		MenuBar.MenuItem synthese = mainmenu.addItem("Générer les synthèses", null);
		...
		MenuBar.MenuItem tableauBord = mainmenu.addItem("Tableau de Bord", null);
	...
	private Command generatePV = new Command() {
		...
		public void menuSelected(MenuItem selectedItem)
		{
			...
			if (returnVal == 0)
			{
				__app.getMainWindow().showNotification("Procés Verbal généré avec succés");
			}
		}
	};
	...
	private Command monthSynthese = new Command() {
		...
		public void menuSelected(MenuItem selectedItem) {
			centrale.setVisible(true);
			switchView(centrale, new MonthlyTimeLine(__app, centrale, "Synthèse du Mois"));
		}
	};
	...
	private Command annualSynthese = new Command() {
		...
		public void menuSelected(MenuItem selectedItem) {
			centrale.setVisible(true);
			switchView(centrale, new AnnualTimeLine(__app, centrale, "Synthèse de l'année"));
		}
	};
